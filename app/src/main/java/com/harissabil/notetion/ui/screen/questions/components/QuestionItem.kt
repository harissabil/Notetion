...
fun QuestionItem(
    ...
    onDeleteClick: (questions: List<QuestionWithAnswers>) -> Unit,
) {
    ...
    Card(
        ...
        Box(modifier = Modifier
            ...
            Column(
                ...
                Text(
                    text = "1. ${questions.first().question.questionText}\n...",
                ...
                Text(
                    text = "Created at ${questions.first().question.createdAt?.localiseDate()}",
                    style = MaterialTheme.typography.bodyMedium,
                    maxLines = 1,
                    overflow = TextOverflow.Ellipsis,
                )
        ...
        DropdownMenu(
            ...
            DropdownMenuItem(
                onClick = {
                    onStartQuizClick(note.noteId)
                    isContextMenuVisible = false
                },
                text = { Text(text = "Start Quiz") }
            )
            DropdownMenuItem(
                onClick = {
                    onDeleteClick(questions)
                    isContextMenuVisible = false
                },
